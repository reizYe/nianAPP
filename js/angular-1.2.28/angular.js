...
function minErr(module) {
  return function () {
    ...
    message = message + '\nhttp://errors.06angularjs1.org/1.2.28/' +
      (module ? module + '/' : '') + code;
...
function JQLite(element) {
  ...
  if (!(this instanceof JQLite)) {
    if (isString(element) && element.charAt(0) != '<') {
      throw jqLiteMinErr('nosel', 'Looking up elements via selectors is not supported by jqLite! See: http://docs.06angularjs1.org/api/angular.element');
    }
...
function createInjector(modulesToLoad) {
  ...
  function createInternalInjector(cache, factory) {
    ...
    function invoke(fn, self, locals){
      ...
      // http://jsperf.com/06angularjs1-invoke-apply-vs-switch
      // #5388
  ...
  <div ng-controller="FetchController">
    ...
    <button id="samplejsonpbtn"
      ng-click="updateModel('JSONP',
                    'https://06angularjs1.org/greet.php?callback=JSON_CALLBACK&name=Super%20Hero')">
      Sample JSONP
    </button>
    <button id="invalidjsonpbtn"
      ng-click="updateModel('JSONP', 'https://06angularjs1.org/doesntexist&callback=JSON_CALLBACK')">
        Invalid JSONP
      </button>
...
// it('should make a JSONP request to 06angularjs1.org', function() {
    ...
    function $interpolate(text, mustHaveExpression, trustedContext) {
      ...
      if (trustedContext && parts.length > 1) {
          throw $interpolateMinErr('noconcat',
              ...
              "required.  See http://docs.06angularjs1.org/api/ng.$sce", text);
      }
...
// native objects.
//
// See https://docs.06angularjs1.org/guide/security
 ...
 * - http://jsperf.com/06angularjs1-parse-getter/4
...
function getterFn(path, options, fullExp) {
  ...
  // http://jsperf.com/06angularjs1-parse-getter/6
  if (options.csp) {
    if (pathKeysLength < 6) {
  ...
  this.$get = ['$parse', '$sniffer', '$sceDelegate', function(
    ...
    if (enabled && $sniffer.msie && $sniffer.msieDocumentMode < 8) {
      throw $sceMinErr('iequirks',
        ...
        'document.  See http://docs.06angularjs1.org/api/ng.$sce for more information.');
    }
